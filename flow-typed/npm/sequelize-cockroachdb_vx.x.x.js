// flow-typed signature: 95481e8b4a3d6f826773e59a20f803df
// flow-typed version: <<STUB>>/sequelize-cockroachdb_v1.0.3/flow_v0.67.1
...
declare module "sequelize-cockroachdb" {
  ...
  */
  ...
  declare type DataTypeString = {} & DataTypeAbstractString<
    DataTypeString,
  >

  declare type DataTypeChar = {} & DataTypeAbstractString<
    DataTypeString,
  >
  ...
  declare type DataTypeNumber = DataTypeAbstractNumber<
    DataTypeNumber,
  > & {}

  declare type DataTypeInteger = DataTypeAbstractNumber<
    DataTypeInteger,
  > & {
    /**
  ...
  declare type DataTypeBigInt = DataTypeAbstractNumber<
    DataTypeBigInt,
  > & {
    /**
     * Length of the number field.
  ...
  declare type DataTypeFloat = DataTypeAbstractNumber<
    DataTypeFloat,
  > & {
    /**
  ...
  declare type DataTypeDouble = DataTypeAbstractNumber<
    DataTypeDouble,
  > & {
    /**
     * Length of the number field and decimals of the real
  ...
  declare type DataTypeDecimal = DataTypeAbstractNumber<
    DataTypeDecimal,
  > & {
    /**
  ...
  */
  ...
  declare export type WhereOptions =
    ...
    | where
    | fn
    | Array<string | number | AndOperator | OrOperator>
  ...
  */
  ...
  > {
    ...
    */
    static scope(
      options?: string | ScopeOptions | Array<string | ScopeOptions>,
    ): Class<this>;
    ...
    */
    ...
    static findCreateFind<TCustomAttributes>(
      options: FindCreateFindOptions<
        TInitAttributes & TCustomAttributes,
      >,
    ): Promise<[this, boolean]>;
  ...
  */
  declare export default class Sequelize {
    ...
    */
     ...
     */
    model<ModelClass: Class<Model<any>>>(
      modelName: string,
    ): ModelClass;
    ...
    */
    ...
    transaction(
      ...
      autoCallback: (t: Transaction) => Promise<any>,
    ): Promise<void>;
    transaction(
      autoCallback: (t: Transaction) => Promise<any>,
    ): Promise<void>;
  ...
  */
  ...
  declare export type TransactionIsolationLevelReadCommitted =
    "READ_COMMITTED"

  declare export type TransactionIsolationLevelRepeatableRead =
    "REPEATABLE_READ"

  declare export type TransactionIsolationLevelSerializable =
    "SERIALIZABLE"
  ...
  */
  ...
  declare export type TransactionLockLevelNoKeyUpdate =
    "NO_KEY_UPDATE"

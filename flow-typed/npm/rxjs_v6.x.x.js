...
type rxjs$ObservableInput<T> =
  | rxjs$Observable<T>
  | Promise<T>
  | Iterable<T>

type rxjs$OperatorFunction<T, R> = (
  rxjs$Observable<T>,
) => rxjs$Observable<R>
...
declare class rxjs$ConnectableObservable<T> extends rxjs$Observable<
  T,
> {
...
declare module "rxjs/operators" {
  declare module.exports: {
    audit<+T>(
      durationSelector: (
        value: T,
      ) => rxjs$Observable<any> | Promise<any>,
    ...
    multicast<+T>(
      subjectOrSubjectFactory: | rxjs$Subject<T>
      | (() => rxjs$Subject<T>),
...
declare class rxjs$GroupedObservable<K, V> extends rxjs$Observable<
  V,
> {
  key: K;
}
...
declare interface rxjs$Operator<T, R> {
  call(
    subscriber: rxjs$Subscriber<R>,
    source: any,
  ): rxjs$TeardownLogic;
}

declare class rxjs$Subject<T>
  mixins rxjs$Observable<T>, rxjs$Observer<T> {
  static create<T>(
...
declare class rxjs$Subscriber<T> extends rxjs$Subscription {
  ...
  constructor(
    destinationOrNext?: | rxjs$PartialObserver<any>
    | ((value: T) => void),
    error?: (e?: any) => void,
    complete?: () => void,
  ): void;
